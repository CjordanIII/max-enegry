...
const DataPage = () => {
    return (
        <div className="flex flex-col min-h-screen space-y-8 pt-20"> {/* Added pt-20 to push content below navbar */}
            <div className="flex justify-center space-x-4"> {/* Flex container to align papers next to each other */}
                {/* Billing Paper */}
                <Paper
                    style={`${billingPaper[0].style} max-w-[660px] w-full sm:w-[425px] h-auto sm:min-h-[350px]`} // Adjusted height here
                    paperLabel={billingPaper[0].paperLabel}
                />

                {/* Usage Paper */}
                <Paper
                    style={`${usagePaper[0].style} max-w-[660px] w-full sm:w-[425px] h-auto sm:min-h-[350px]`} // Adjusted height here
                    paperLabel={usagePaper[0].paperLabel}
                />

                {/* Smart Pricing Plan Paper */}
                <Paper
                    style={`${smartPricingPaper[0].style} max-w-[660px] w-full sm:w-[425px] h-auto sm:min-h-[350px]`} // Adjusted height here
            ...
            <div>
                {/* More Info Paper */}
                <Paper
                    style={`${moreInfoPaper[0].style} max-w-[1300px] w-full h-auto sm:min-h-[350px] mx-auto`} // Adjusted height here
